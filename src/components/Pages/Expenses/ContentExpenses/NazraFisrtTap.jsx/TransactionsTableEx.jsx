...
const transactions = [
  { date: "2 مارس 2025", name: "شراء سوبر ماركت", category: "خضار", amount: "80.00 $", status: "مكتمل" },
  { date: "18 مارس 2025", name: "كشف أسنان", category: "صحة", amount: "100.00 $", status: "مكتمل" },
  { date: "2 مارس 2025", name: "إيجار المنزل", category: "المنزل", amount: "780.00 $", status: "مكتمل" },
  { date: "14 مارس 2025", name: "اشتراك نتفلكس", category: "ترفيه", amount: "7.50 $", status: "مكتمل" },
  { date: "18 مارس 2025", name: "كشف أسنان", category: "صحة", amount: "100.00 $", status: "مكتمل" },
    { date: "2 مارس 2025", name: "إيجار المنزل", category: "المنزل", amount: "780.00 $", status: "مكتمل" },
  { date: "14 مارس 2025", name: "اشتراك نتفلكس", category: "ترفيه", amount: "7.50 $", status: "مكتمل" },
  { date: "18 مارس 2025", name: "كشف أسنان", category: "صحة", amount: "100.00 $", status: "مكتمل" },
...
export default function TransactionsTableEx() {
  ...
  const categories = ["الكل", ...new Set(transactions.map((tx) => tx.category))];

  // تصفية العمليات بناءً على الفئة المختارة
    ...
    <div className="bg-white h-auto p-4 rounded-2xl shadow-xl border-1 rtl text-right">
      <div className="flex flex-col md:flex-row md:justify-between md:items-center mb-4 gap-2">
        ...
        <div className="flex items-center gap-2">
          ...
          {/* Dropdown فلترة الفئات */}
          <select
            className="flex w-[130px] h-[48px] items-center border p-2 px-3 rounded-md text-sm text-gray-700"
