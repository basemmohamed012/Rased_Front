...
export default function PerformanceChart() {
  return (
   <div className='w-[1020px] h-[590px]'>
     <div className='w-[1020px] h-[514px] rounded-[20px] bg-white shadow-lg border-2 p-6' style={{ direction: 'rtl' }}>
      <div className='mb-10'>
        <h3 className="font-bold text-[22px] leading-[100%] mb-4 tracking-[0%] text-right">
          المصروفات بالاعوام السابقة
        </h3>
        <p className="font-bold text-[#A6A6A6] text-[12px] leading-[100%] tracking-[0%] text-right">
           الاداء المصروفات مقارنة بأعوام سابقة
        </p>
      </div>
      <div>
