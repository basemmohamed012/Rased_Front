...
export default function TransactionsTableEx() {
  ...
  return (
    <div className="bg-white h-auto p-4 rounded-2xl shadow-xl border-1 rtl text-right">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          {/* <div className="relative">
            <input
              ...
              className="border w-[232px] h-[48px] rounded-md pl-10 pr-3 py-2 text-sm focus:outline-none focus:ring focus:ring-blue-200"
            />
          ...
          {/* Category Filter */}
          {/* <select
            className="flex w-[130px] h-[48px] items-center border p-2 px-3 rounded-md text-sm text-gray-700 bg-white"
          ...
          <table className="min-w-full text-sm">
            <thead>
              <tr className="text-[18px] font-bold border-b-2 border-gray-200">
                ...
                <th className="p-2 whitespace-nowrap text-left">الإجراء</th>
              </tr>
            </thead>
            <tbody>
                  ...
                  <tr key={tx.id} className="border-b hover:bg-gray-50 transition-colors">
                    ...
                    <td className="py-4 px-2 flex justify-end">
                      <div className="flex gap-2 justify-start">
                        <button className="text-warning hover:text-yellow-400 p-1 rounded transition-colors"
                          onClick={() => handleUpdateExpense(tx.expenseId)}
                        >
                          <Edit3 className="w-4 h-4" />
                        </button>
                        <button className="text-error hover:text-red-400 p-1 rounded transition-colors"
                          onClick={() => { setShowDeleteModal(true); setExpenseId(tx.expenseId); }}  
                        >
