      ...
      <section className="mx-auto my-10 p-4">
        ...
        <div className="space-y-8 relative right-0  bottom-16 max-w-[95%] sm:max-w-[93%] mx-auto">
          {[
            ...
            {
              question: "كيف يعمل الذكاء الاصطناعي في تطبيق راصد؟",
              answer: "يستخدم راصد الذكاء الاصطناعي لاستخراج البيانات من صور الفواتير تلقائياً، كما يقدم نصائح شخصية لتحسين إدارة أموالك وتوفير استراتيجيات مالية ذكية."
            },
            {
              question: "ما هي المحافظ المشتركة وكيف تعمل؟",
              answer: "المحافظ المشتركة تسمح لك بمشاركة إدارة الأموال مع أفراد العائلة أو الأصدقاء، حيث يمكن لعدة أشخاص متابعة المصروفات والإيرادات المشتركة وتنظيمها معاً."
            },
            {
              question: "هل تطبيق راصد آمن لحفظ بياناتي المالية؟",
              answer: "نعم، راصد يوفر حماية عالية من خلال نظام المصادقة الثنائية عبر البريد الإلكتروني وتشفير البيانات، مما يضمن أمان معلوماتك المالية الحساسة."
            },
            {
              question: "كيف يمكنني تحويل الأموال باستخدام التطبيق؟",
              answer: "يمكنك تحويل الأموال بسهولة بين محافظك الشخصية أو إرسالها لمستخدمين آخرين في التطبيق، مع واجهة بسيطة وآمنة تجعل العملية سريعة ومريحة."
            }
          ].map((item, index) => (
