...
const EditSharedWalletModal = ({ onClose, onEdit, walletId, token, editLoading }) => {
  ...
  useEffect(() => {
    const fetchWallet = async () => {
      const apiUrl = `${API_BASE_URL}/SharedWallets/Single/${walletId}`;
      try {
        // API Call
...
export default EditSharedWalletModal