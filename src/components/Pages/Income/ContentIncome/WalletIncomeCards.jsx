...
const WalletIncomeCards = () => {
  ...
  const fetchIncomes = async (walletId) => {    
    ...
    try {
      ...
      const apiUrl = `${API_BASE_URL}/incomes/GetAllIncomes/${walletId}`;
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-4">
      ...
      <div className="p-6 flex justify-between items-center">
        <h2 className="w-2/3 text-xl font-bold text-maincolor mb-4">ابحث باسم المحفظة الشخصية</h2>
        <select
...
export default WalletIncomeCards;